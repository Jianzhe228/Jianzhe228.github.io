...
![image-20250329015034541](https://images.guangyin.blog/2025/03/05e9f7822ca84c1403b0e7b3bb1c4126.webp)

所以，select 后边的字段尽量不要直接使用`*`，而是明确的使用字段名，一个是为了减少回表的发生，第二个是减少以后添加新字段时，不会影响现有的查询sql查询的结果，以产生意料之外的bug。

###### 5、B+树索引和哈希索引

![image-20250329010958816](https://images.guangyin.blog/2025/03/daa6b4181e8b597e2849a1baf2c85660.webp)
...
![image-20250329012334382](https://images.guangyin.blog/2025/03/b8f687303ed502210e97c846585f49b8.webp)
...
###### 13、Innodb自适应哈希索引
 ...
 ![image-20250329015255357](https://images.guangyin.blog/2025/03/1d2f9b4c24cff3c70ffbcd7da60cd019.webp)   
